...
func init() {
	const HPAController = "github.com/aaawoyucheng/wayne/src/backend/controllers/hpa:HPAController"
	...
	const HPATplController = "github.com/aaawoyucheng/wayne/src/backend/controllers/hpa:HPATplController"
