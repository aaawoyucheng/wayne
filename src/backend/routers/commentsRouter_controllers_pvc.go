...
func init() {
	const PersistentVolumeClaimController = "github.com/aaawoyucheng/wayne/src/backend/controllers/pvc:PersistentVolumeClaimController"
	...
	const PersistentVolumeClaimTplController = "github.com/aaawoyucheng/wayne/src/backend/controllers/pvc:PersistentVolumeClaimTplController"
