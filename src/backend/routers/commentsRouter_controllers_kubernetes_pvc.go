...
func init() {
	const KubePersistentVolumeClaimController = "github.com/aaawoyucheng/wayne/src/backend/controllers/kubernetes/pvc:KubePersistentVolumeClaimController"
	...
	const RobinPersistentVolumeClaimController = "github.com/aaawoyucheng/wayne/src/backend/controllers/kubernetes/pvc:RobinPersistentVolumeClaimController"
